...
VALUES
    ...
    (3,3,1,'8015559012',CURRENT_TIMESTAMP,'0'),
    (4,1,2,'8015553456',CURRENT_TIMESTAMP,'1');
...
VALUES
    (1,1,'Computer Science Student','profile.jpg',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP),
    (2,2,'Old Singer','profile.jpg',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
...
VALUES
    (1,'Week 1','Overview and Setup','Create the GitHub repositories.  Discuss AWS Academy, databases, containers, schemas.  Docker Compose Assignment','https://yt3.googleusercontent.com/vtckU0sW8j7MgqC6SnO4Ed3yaG0t-fFwhUEir-9SMTOuYBIXPkfSx3fzD3YrwUj8PI46fw1Le9o=s160-c-k-c0x00ffffff-no-rj'Links to an external site.,'Week 1 - Overview and Setup'),
